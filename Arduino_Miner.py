...
try:
    ...
    print(now.strftime("%H:%M:%S ") + "✗ Requests is not installed. Please install it with python3 -m pip install requests")
    time.sleep(15)
    os._exit(0)
...
try:
    ...
    now = datetime.datetime.now()
    print(now.strftime("%H:%M:%S ") + "✗ pySerial is not installed. Please install it with pip install pyserial")
    time.sleep(15)
    os._exit(0)
...
try:
    ...
    now = datetime.datetime.now()
    print(now.strftime("%H:%M:%S ") + "✗ Serial.tools.list_ports is not installed. Please install it with pip install serial.tools.list_ports")
    time.sleep(15)
    os._exit(0)
