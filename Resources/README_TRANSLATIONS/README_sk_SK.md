...
<details>
  ...
  ### Upozorňujeme, že odmeny závisia od mnohých faktorov a nižšie uvedená tabuľka slúži len na orientačné účely.
  
  | Zariadenie/CPU/SBC/MCU/čip                                | Priemerný hashrate<br>(všetky vlákna) | Ťažobné<br>vlákna | Spotreba energie<br> | Priemer<br>DUCO/deň |
  |-----------------------------------------------------------|-----------------------------------|-------------------|----------------|---------------------|
  ...
  Všetky testy boli vykonané pomocou algoritmu DUCO-S1. Táto tabuľka bude aktívne aktualizovaná.
</details>
...
<details>
  ...
  *   [Duino-JS](https://github.com/Hoiboy19/Duino-JS) - JavaScript miner, ktorý môžete jednoducho implementovať na svoje stránky od Hoiboy19
  *   [Mineuino](https://github.com/VatsaDev/Mineuino) - speňaženie webových stránok od VatsaDev
  *   [hauchel's duco-related stuff repository](https://github.com/hauchel/duco/) - Zbierka rôznych kódov na ťažbu DUCO na iných mikrokontroléroch
  *   [duino-coin-php-miner](https://github.com/ricardofiorani/duino-coin-php-miner) Dockerized Miner v PHP od ricardofiorani
  *   [duino-coin-kodi](https://github.com/SandUhrGucker/duino-coin-kodi) - Ťažobný doplnok pre Kodi Media Center od SandUhrGucker
  *   [MineCryptoOnWifiRouter](https://github.com/BastelPichi/MineCryptoOnWifiRouter) - Python skript na ťažbu Duino-Coin na routeroch od BastelPichi
  *   [Duino-Coin_Android_Cluster Miner](https://github.com/DoctorEenot/DuinoCoin_android_cluster) - Ťažte s menším počtom pripojení na viacerých zariadeniach od DoctorEenot
  ...
  *   [Neoficiálny miner directory](https://github.com/revoxhere/duino-coin/tree/master/Unofficial%20miners)
  ...
  ### Iné nástroje:
  *   [DUINO Mining Rig](https://repalmakershop.com/pages/duino-mining-rig) - 3D súbory, návrhy dosiek plošných spojov a pokyny na vytvorenie vlastného Duino-Coin rig-u od ReP_AL
  *   [DuinoCoin-balance-Home-Assistant](https://github.com/NL647/DuinoCoin-balance-Home-Assistant) - doplnok pre domáceho asistenta zobrazujúci váš zostatok podľa NL647
  *   [Duino Coin Status Monitor](https://github.com/TSltd/duino_coin) pre 128x64 SSD1306 OLED a ESP8266 od TSltd
  *   [ducopanel](https://github.com/ponsato/ducopanel) - aplikácia GUI na ovládanie minerov Duino-Coin od Ponsato
  *   [Duino AVR Monitor](https://www.microsoft.com/store/apps/9NJ7HPFSR9V5) - GUI Windows aplikácia na monitorovanie zariadení AVR ťažiacich DUCO od niknak
  *   [Duino-Coin Arduino library](https://github.com/ricaun/arduino-DuinoCoin) od ricaun
  *   [DuinoCoinI2C](https://github.com/ricaun/DuinoCoinI2C) - Použite ESP8266/ESP32 ako master pre Arduina od ricaun
  *   [Duino-Coin Mining Dashboard](https://lulaschkas.github.io/duco-mining-dashboard/) pomocník pri riešení problémov od Lulaschkas
  *   [duco-miners](https://github.com/dansinclair25/duco-miners) CLI ťažobný dashboard od dansinclair25
  *   [Duco-Coin Symbol Icon ttf](https://github.com/SandUhrGucker/Duco-Coin-Symbol-Icon-ttf-.h) od SandUhrGucker
  *   [DUCO Browser Extension](https://github.com/LDarki/DucoExtension) pre Chrome a deriváty od LDarki
  *   [DUCO Monitor](https://siunus.github.io/duco-monitor/) webová stránka štatistiky účtu od siunus
  *   [duino-tools](https://github.com/kyngs/duino-tools) napísané v Jave od kyngs
  *   [Duino Stats](https://github.com/Bilaboz/duino-stats) oficiálny Discord bot od Bilaboz
  *   [DuCoWallet](https://github.com/viktor02/DuCoWallet) GUI peňaženka od viktor02
  *   [Duco-widget-ios](https://github.com/naphob/duco-widget-ios) - IOS widget pre Duino-Coin od Naphob

  Podobný zoznam si môžete pozrieť aj na [webovej lokalite](https://duinocoin.com/apps).
</details>
