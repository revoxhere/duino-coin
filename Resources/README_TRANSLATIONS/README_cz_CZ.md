...
<details>
  ...
  Všechny testy byly vykonány za pomocí algoritmu DUCO-S1. Tato tabulka je pravidelně aktualizovaná.
</details>
...
<details>
  ...
  *   [DuinoCoinbyLabVIEW](https://github.com/ericddm/DuinoCoinbyLabVIEW) - těžební program pro rodinu LabVIEW od ericddm
  *   [Duino-JS](https://github.com/Hoiboy19/Duino-JS) - JavaScript těžební program, který můžete vložit na své webové stránky od Hoiboy19
  *   [Mineuino](https://github.com/VatsaDev/Mineuino) - zpěněžení webových stránek od VatsaDev
  *   [hauchel's duco-related stuff repository](https://github.com/hauchel/duco/) - Sbírka různých kódů na těžbu DUCO na jiných mikrokontrolérech
  *   [duino-coin-php-miner](https://github.com/ricardofiorani/duino-coin-php-miner) - Těžební program v Dockeru v PHP od ricardofiorani
  *   [duino-coin-kodi](https://github.com/SandUhrGucker/duino-coin-kodi) - Těžební doplněk pro Kodi Media Center od SandUhrGucker
  *   [MineCryptoOnWifiRouter](https://github.com/BastelPichi/MineCryptoOnWifiRouter) - Python skript na těžbu Duino-Coinu na routerech od BastelPichi
  *   [Duino-Coin_Android_Cluster Miner](https://github.com/DoctorEenot/DuinoCoin_android_cluster) - Těžte na měnším počtu připojení na více zařízeních od DoctorEenot
  *   [ESPython DUCO Miner](https://github.com/fabiopolancoe/ESPython-DUCO-Miner) - Těžební mikropython program pro ESP desky od fabiopolancoe
  *   [DUCO Miner for Nintendo 3DS](https://github.com/BunkerInnovations/duco-3ds) - Python těžební program pro Nintendo 3DS od PhereloHD & HGEpro
  *   [Dockerized DUCO Miner](https://github.com/Alicia426/Dockerized_DUCO_Miner_minimal) - Těžební program v Dockeru od Alicie426
  *   [NodeJS-DuinoCoin-Miner](https://github.com/DarkThinking/NodeJS-DuinoCoin-Miner/) - jednoduchý nodeJS těžební program od DarkThinking
  *   [d-cpuminer](https://github.com/phantom32-0/d-cpuminer) - Těžební program v C od phantom32 & revoxhere
  *   [Go Miner](https://github.com/yippiez/go-miner) od yippiez
  *   [ducominer](https://github.com/its5Q/ducominer) od its5Q
  *   [Neoficiální knihovna těžebních programů](https://github.com/revoxhere/duino-coin/tree/master/Unofficial%20miners)
      *   [Julia Miner](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Julia_Miner.jl) od revoxhere
      *   [Ruby Miner](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Ruby_Miner.rb) od revoxhere
      *   [Minimal Python Miner (DUCO-S1)](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Minimal_PC_Miner.py) od revoxhere
      *   [Teensy 4.1 code for Arduino IDE](https://github.com/revoxhere/duino-coin/blob/master/Unofficial%20miners/Teensy_code/Teensy_code.ino) od joaquinbvw

  ### Další nástroje:
  *   [DUINO Mining Rig](https://repalmakershop.com/pages/duino-mining-rig) - 3D soubory, návrhy desek plošných spojů a pokyny k vytvoření vlastního Duino-Coin rigu od ReP_AL
  *   [DuinoCoin-balance-Home-Assistant](https://github.com/NL647/DuinoCoin-balance-Home-Assistant) - integrace pro Home Assistanta zobrazující zůstatek v Duino-Coin peněžence od NL647
  *   [Duino Coin Status Monitor](https://github.com/TSltd/duino_coin) pro 128x64 SSD1306 OLED a ESP8266 od TSltd
  *   [ducopanel](https://github.com/ponsato/ducopanel) - grafická aplikace pro ovládání težebních Duino-Coin počítačů od Ponsato
  *   [Duino AVR Monitor](https://www.microsoft.com/store/apps/9NJ7HPFSR9V5) - Grafická Windows aplikace k monitoringu zařízení AVR pro těžbu DUCO od niknak
  *   [Duino-Coin Arduino library](https://github.com/ricaun/arduino-DuinoCoin) od ricaun
  *   [DuinoCoinI2C](https://github.com/ricaun/DuinoCoinI2C) - Využití ESP8266/ESP32 jako master zařízení pro Arduina od ricaun
  *   [Duino-Coin Mining Dashboard](https://lulaschkas.github.io/duco-mining-dashboard/) - alternativní dashboard a rádce při řešení problémů od Lulaschkas
  *   [duco-miners](https://github.com/dansinclair25/duco-miners) - dashboard v příkazové řádce od dansinclair25
  *   [Duco-Coin Symbol Icon ttf](https://github.com/SandUhrGucker/Duco-Coin-Symbol-Icon-ttf-.h) od SandUhrGucker
  *   [DUCO Browser Extension](https://github.com/LDarki/DucoExtension) - rozšíření pro Chrome a prohlížeče založené na Chromiu od LDarki
  *   [DUCO Monitor](https://siunus.github.io/duco-monitor/) - web pro přístup ke statistikám účtu od siunus
  *   [duino-tools](https://github.com/kyngs/duino-tools) - nástroje napsané v Javě od kyngs
  *   [Duino Stats](https://github.com/Bilaboz/duino-stats) oficiální Discord bot od Bilaboz
  *   [DuCoWallet](https://github.com/viktor02/DuCoWallet) GUI peněženka od viktor02
  *   [Duco-widget-ios](https://github.com/naphob/duco-widget-ios) - iOS widget pro Duino-Coin od Naphob

  Podobný seznam si můžete prohlédnout i na [webové stránce projektu](https://duinocoin.com/apps).
</details>
