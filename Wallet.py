...
def About():
        ...
        tkinter.Button(about, text = "Duino-Coin GitHub", activebackground = str(colorHighlight), command = GitHub, fg = str(colorB), bg = str(colorA), width = 46).pack()
