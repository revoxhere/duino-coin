...
New Alpha 6 server now has built-in API so it will be easier for us to get and display these statistics.
Other than that, you now can find *Exchange* button in Wallet, along with some fixes.
